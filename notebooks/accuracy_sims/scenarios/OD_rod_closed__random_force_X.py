...
scenario_name = 'random_force_rand_%s' % rndstr
print(scenario_name)
...
# + active=""
# plt.plot(all_Rf_sup_err['integrator_OD_FE'][0.0001])
# plt.plot(all_Rf_sup_err['integrator_OD_SE3'][0.0001])
# plt.yscale('log')
# -
